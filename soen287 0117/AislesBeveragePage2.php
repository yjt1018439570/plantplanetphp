		...
		<div class="row">
			...
			<div class="col-9" style="margin-bottom:50px;">
				<div class = "products"> <!--insert link to specific product here-->
					<a href= "BeveragesMarsWater.php"><div>
						<div class = "pimage">
							<img src ="mars-water.jpg">
						</div>
						<div>
							<div class = "pname">Mars Water</div>
							<div class = "pinfo">500 ml<br />$1.25 ea.</div>
						</div>
					</div></a>
					<a href= "BeveragesJupiterJuice.php"><div>
						<div class = "pimage">
							<img src ="jupiter-juice.jpg">
						</div>
						<div>
							<div class = "pname">Jupiter Juice</div>
							<div class = "pinfo">2 L<br />$2.50 ea.</div>
						</div>
					</div></a>
					<a href= "BeveragesCosmicSoda.php"><div>
						<div class = "pimage">
							<img src ="cosmic-soda.jpg">
						</div>
						<div>
							<div class = "pname">Cosmic Soda</div>
							<div class = "pinfo">500 ml<br />$2.99 ea.</div>
						</div>
					</div></a>
					<a href= "BeveragesMilkyWayMilk.php"><div>
						<div class = "pimage">
							<img src ="milky-way-milk.jpg">
						</div>
						<div>
							<div class = "pname">Milky Way Milk</div>
							<div class = "pinfo">2 L<br />$3.99 ea.</div>
						</div>
					</div></a>
				</div>
				<div class = "pages">
					...
					<form action = "">
						<a href="AislesBeverages.php" input type = "button" class="previous" style="float:left;margin-left:5px;">&laquo; Previous Page </a>
					</form>
				</div>
			</div>
		</div>
